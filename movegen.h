...
private:
    static void pawnMoves(Board &board, uint8_t startPos, Bitboard bitPos);
    static void knightMoves(Board &board, uint8_t startPos, Bitboard bitPos);
    static void bishopMoves(Board &board, uint8_t startPos, Bitboard bitPos);
    static void rookMoves(Board &board, uint8_t startPos, Bitboard bitPos);
    static void kingMoves(Board &board, uint8_t startPos, Bitboard bitPos);
